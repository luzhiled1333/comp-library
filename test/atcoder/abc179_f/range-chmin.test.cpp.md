...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/abc179_f/range-chmin.test.cpp\"\n// verification-helper:\
    ...
    \ const noexcept {\n      return l;\n    }\n  };\n\n} // namespace luz\n#line\
    \ 2 \"src/data-structure/segment-tree/presets/range-chmin-query-solver.hpp\"\n\
    \n#line 2 \"src/data-structure/segment-tree/presets/monoid/operator-structure-chmin.hpp\"\
    \n\n#line 4 \"src/data-structure/segment-tree/presets/monoid/operator-structure-chmin.hpp\"\
    ...
    \ luz\n#line 7 \"test/atcoder/abc179_f/range-chmin.test.cpp\"\n\n#include <iostream>\n\
    \nnamespace luz {\n\n  void main_() {\n    usize n, q;\n    std::cin >> n >> q;\n\
  ...
  code: "// verification-helper: PROBLEM https://atcoder.jp/contests/abc179/tasks/abc179_f\n\
    ...
    \n\n#include <iostream>\n\nnamespace luz {\n\n  void main_() {\n    usize n, q;\n\
    \    std::cin >> n >> q;\n\n    RangeChminQuerySolver< i32 > v_seg(n, n - 1),\
  ...
  verifiedWith: []
documentation_of: test/atcoder/abc179_f/range-chmin.test.cpp
layout: document
redirect_from:
- /verify/test/atcoder/abc179_f/range-chmin.test.cpp
- /verify/test/atcoder/abc179_f/range-chmin.test.cpp.html
