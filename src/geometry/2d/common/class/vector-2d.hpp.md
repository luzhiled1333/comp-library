...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"src/geometry/2d/common/class/vector-2d.hpp\"\n\n#line 2\
  ...
  verifiedWith: []
documentation_of: src/geometry/2d/common/class/vector-2d.hpp
layout: document
redirect_from:
- /library/src/geometry/2d/common/class/vector-2d.hpp
- /library/src/geometry/2d/common/class/vector-2d.hpp.html
